...
class RecipeImageUploadTest(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title="Gyro")
        tag1 = sample_tag(user=self.user, name="Vegan")
    ...
    def test_filter_recipe_by_ingredients(self):
        recipe1 = sample_recipe(self.user, title="Beans on Toast")
        recipe2 = sample_recipe(self.user, title="Buffalo Chicken")
        ingredient1 = sample_ingredient(self.user, name="can of beans")
        ingredient2 = sample_ingredient(self.user, name="Chicken")
        recipe1.ingredients.add(ingredient1)
        recipe2.ingredients.add(ingredient2)
        recipe3 = sample_recipe(self.user, title="Pork Pie")
